<h2>510. Inorder Successor in BST II</h2><h3>Medium</h3><hr><div><p>Given a <code>node</code> in a binary search tree, find&nbsp;the in-order successor of that node in the BST.</p>
