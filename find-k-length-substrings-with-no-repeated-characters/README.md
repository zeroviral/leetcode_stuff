<h2>1100. Find K-Length Substrings With No Repeated Characters</h2><h3>Medium</h3><hr><div><p>Given a string <code>S</code>, return the number of substrings of length <code>K</code> with no repeated characters.</p>
